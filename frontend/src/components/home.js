    ...
    <div className='home'>

        {
          data.map((item) => {
            return (
              <div className='card'>
        <div className='card-header' style={{borderBottom : "1px solid rgb(127,127,127"}}>
      ...
      <div className='showComments'>
        <div className='container'>
          ...
          <h5>{item.user.username}</h5>
            ...
            <div className='comment-section'>

              {
                item.comments.map((comment) => {
                  ...
                  <span className='commenter' style={{fontWeight : "bolder"}}>{comment.user.username} </span>
            ...
            <div className='card-content' style={{borderTop : "1px solid #00000029"}}>
